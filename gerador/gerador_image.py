...
with open("C:\\Users\\vasco\\OneDrive - Universidade de Lisboa\\Universidade\\2ºAno\\2ºSemestre\\InteligênciaArtificial\\Projeto\\gerador\\" + save + ".txt", 'w') as f:
    for i in range(size):
        if i != 0:
            f.write("\n")
            print("\n")
